...
export const SURFACE_REGISTRY: SurfaceDescriptor[] = [
  ...
  },
  {
    ...
    status: 'implemented',
    blocksActivation: true,
    notes: 'Scored by db-coverage-scanner.mjs (requires egress to *.supabase.co).',
  },
  {
    id: 'lesson-titles',
    ...
    status: 'implemented',
    blocksActivation: true,
    notes: 'Title sub-field scored by db-coverage-scanner.mjs.',
  },
  {
    id: 'lesson-body',
    ...
    status: 'implemented',
    blocksActivation: true,
    notes: 'Description sub-field scored by db-coverage-scanner.mjs. Largest content volume.',
  },
  {
    id: 'quiz-questions',
