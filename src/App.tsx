...
import LanguageCommandCenter from "./pages/founder/LanguageCommandCenter";
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/founder/language-quality" element={<FounderRoute><LanguageCommandCenter /></FounderRoute>} />
