...
export const PROGRAM_CATALOG: ProgramNames[] = [
  ...
  { en: 'AI Project Manager & Delivery Leader', es: 'Gerente de Proyectos con IA y Líder de Entrega', fr: 'Chef de Projet IA et Leader de Livraison', pt: 'Gerente de Projetos com IA e Líder de Entrega', de: 'KI-Projektmanager & Delivery Leader', ar: 'مدير مشاريع الذكاء الاصطناعي وقائد التسليم', zh: 'AI项目经理与交付领导者', hi: 'एआई प्रोजेक्ट मैनेजर और डिलीवरी लीडर', aliases: ['Project Management Professional Certification'] },
