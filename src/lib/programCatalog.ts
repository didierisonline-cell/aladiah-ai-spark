...
export const PROGRAM_CATALOG: ProgramNames[] = [
  ...
  { en: 'AI Business Analyst', es: 'Analista de Negocios con IA', fr: 'Analyste Métier IA', pt: 'Analista de Negócios com IA', de: 'KI-Business-Analyst', ar: 'محلل أعمال الذكاء الاصطناعي', zh: 'AI业务分析师', hi: 'एआई बिज़नेस विश्लेषक' },
