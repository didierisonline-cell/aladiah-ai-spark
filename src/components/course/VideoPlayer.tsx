...
const VideoPlayer = ({ 
  ...
  return (
    <div className="flex gap-4">
            ...
            {hasStarted && (
              <>
                ...
                <div className="flex items-center justify-center gap-3 mb-4">
                  ...
                  <Button variant="ghost" size="icon" onClick={toggleMute} title="Mute">
                    {isMuted ? <VolumeX className="w-5 h-5" /> : <Volume2 className="w-5 h-5" />}
                  </Button>

                  <Button variant="ghost" size="sm" onClick={cycleSpeed} className="text-xs h-9 px-2 font-mono" title="Playback speed">
      ...
      {/* Side Panel - Transcript or Notes */}
      <AnimatePresence>
        {(showTranscript || showNotes) && (
          <motion.div
            ...
            className="hidden lg:block h-[600px] flex-shrink-0"
          >
            {showTranscript && (
              <TranscriptPanel
                script={script}
