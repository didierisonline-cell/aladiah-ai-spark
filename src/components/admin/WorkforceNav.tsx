...
import { Award, BarChart3, BookOpen, Briefcase, Cpu, GraduationCap, Inbox, LayoutGrid, Megaphone, Rocket, Search, Server, ServerCog, ShieldCheck, Sparkles } from 'lucide-react';
