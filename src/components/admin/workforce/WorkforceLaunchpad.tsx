...
const SURFACES: Surface[] = [
  ...
  { key: 'interface', title: 'Interface & Experience', blurb: 'UX, navigation, accessibility, design polish', icon: LayoutGrid, to: '/admin/interface-agent', slug: 'interface-experience' },
