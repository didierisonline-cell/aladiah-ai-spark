...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'referral.affiliate.description': 'You don\'t need to be a student. Refer 5 people who fully register and pay for any Aladiah Academy course. Once all 5 are enrolled, you earn $1,000 — it\'s that simple.',
    ...
    'referral.affiliate.step3': 'All 5 referrals complete full registration and payment',
    'referral.affiliate.step4': 'You receive $1,000 deposited to your account',
    'referral.affiliate.reward': 'Earn $1,000 for every 5 paid registrations',
  ...
  es: {
    ...
    'referral.affiliate.description': 'No necesitas ser estudiante. Refiere a 5 personas que se registren y paguen cualquier curso de Aladiah Academy. Una vez inscritos los 5, ganas $1,000.',
    ...
    'referral.affiliate.step3': 'Los 5 referidos completan registro y pago',
    'referral.affiliate.step4': 'Recibes $1,000 depositados en tu cuenta',
    'referral.affiliate.reward': 'Gana $1,000 por cada 5 registros pagados',
  ...
  zh: {
    ...
    'referral.affiliate.description': '您不需要是学生。推荐5个人完成注册并支付任何Aladiah Academy课程。5人全部注册后，您即可获得$1,000。',
    'referral.affiliate.step1': '免费注册成为Aladiah Academy联盟成员',
    'referral.affiliate.step2': '在您的网络中分享您的专属联盟链接',
    'referral.affiliate.step3': '5位推荐人完成注册和付款',
    'referral.affiliate.step4': '您将收到$1,000存入您的账户',
    'referral.affiliate.reward': '每5个付费注册赚取$1,000',
  ...
  ar: {
    ...
    'referral.affiliate.description': 'لا تحتاج أن تكون طالبًا. أحِل 5 أشخاص يسجلون ويدفعون لأي دورة في أكاديمية علاديا. بمجرد تسجيل الخمسة، تكسب $1,000.',
    'referral.affiliate.step1': 'سجّل كشريك في أكاديمية علاديا (مجانًا)',
    'referral.affiliate.step2': 'شارك رابط الشراكة في شبكتك',
    'referral.affiliate.step3': 'يكمل المُحالون الخمسة التسجيل والدفع',
    'referral.affiliate.step4': 'تحصل على $1,000 في حسابك',
    'referral.affiliate.reward': 'اكسب $1,000 لكل 5 تسجيلات مدفوعة',
  ...
  fr: {
    ...
    'referral.affiliate.description': 'Vous n\'avez pas besoin d\'être étudiant. Parrainez 5 personnes qui s\'inscrivent et paient un cours Aladiah Academy. Une fois les 5 inscrits, vous gagnez $1,000.',
    ...
    'referral.affiliate.step3': 'Les 5 filleuls complètent l\'inscription et le paiement',
    'referral.affiliate.step4': 'Vous recevez $1,000 déposés sur votre compte',
    'referral.affiliate.reward': 'Gagnez $1,000 pour 5 inscriptions payées',
  ...
  de: {
    ...
    'referral.affiliate.description': 'Sie müssen kein Student sein. Empfehlen Sie 5 Personen, die sich registrieren und für einen Kurs der Aladiah Academy bezahlen. Sobald alle 5 eingeschrieben sind, verdienen Sie $1,000.',
    ...
    'referral.affiliate.step3': 'Alle 5 Empfehlungen schließen Registrierung und Zahlung ab',
    'referral.affiliate.step4': 'Sie erhalten $1,000 auf Ihr Konto',
    'referral.affiliate.reward': 'Verdienen Sie $1,000 pro 5 bezahlte Registrierungen',
  ...
  ja: {
    ...
    'referral.affiliate.description': '学生である必要はありません。Aladiah Academyのコースに登録・支払いを完了する5人を紹介してください。5人全員が登録すると、$1,000を獲得できます。',
    'referral.affiliate.step1': 'Aladiah Academyアフィリエイトに無料登録',
    'referral.affiliate.step2': 'ネットワークでアフィリエイトリンクを共有',
    'referral.affiliate.step3': '5人全員が登録と支払いを完了',
    'referral.affiliate.step4': 'あなたのアカウントに$1,000が振り込まれます',
    'referral.affiliate.reward': '5件の有料登録ごとに$1,000獲得',
