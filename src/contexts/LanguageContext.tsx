...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'referral.student.description': 'As a current Aladiah Academy student, refer 5 friends who fully register and complete at least 30% of their coursework. Once all 5 hit the milestone, you earn $1,000 cash — no strings attached.',
    ...
    'referral.student.step3': 'All 5 referrals complete at least 30% of their coursework',
    'referral.student.step4': 'You receive $1,000 deposited to your account',
    'referral.student.reward': 'Earn $1,000 when all 5 referrals reach 30% completion',
    ...
    'referral.affiliate.description': 'You don\'t need to be a student. Refer 5 people who fully register, pay for any Aladiah Academy course, and complete at least 30% of their coursework. Once all 5 qualify, you earn $1,000.',
    ...
    'referral.affiliate.step3': 'All 5 referrals complete registration, payment, and 30% coursework',
    'referral.affiliate.step4': 'You receive $1,000 deposited to your account',
    'referral.affiliate.reward': 'Earn $1,000 when all 5 referrals complete 30% of their course',
    ...
    'referral.terms.t2': 'Student referral rewards require all 5 referrals to complete a minimum of 30% of their enrolled course.',
  ...
  es: {
    ...
    'referral.student.description': 'Como estudiante activo de Aladiah Academy, refiere a 5 amigos que se registren completamente y completen al menos el 30% de sus cursos. Una vez que los 5 alcancen el hito, recibes $1,000 en efectivo.',
    ...
    'referral.student.step3': 'Los 5 referidos completan al menos el 30% de su curso',
    'referral.student.step4': 'Recibes $1,000 depositados en tu cuenta',
    'referral.student.reward': 'Gana $1,000 cuando tus 5 referidos alcancen el 30%',
    ...
    'referral.affiliate.description': 'No necesitas ser estudiante. Refiere a 5 personas que se registren, paguen cualquier curso de Aladiah Academy y completen al menos el 30% del contenido. Una vez que los 5 califiquen, ganas $1,000.',
    ...
    'referral.affiliate.step3': 'Los 5 referidos completan registro, pago y 30% del curso',
    'referral.affiliate.step4': 'Recibes $1,000 depositados en tu cuenta',
    'referral.affiliate.reward': 'Gana $1,000 cuando los 5 referidos completen el 30% del curso',
    ...
    'referral.terms.t2': 'Las recompensas de referidos estudiantiles requieren que los 5 referidos completen un mínimo del 30% de su curso.',
  ...
  ar: {
    ...
    'referral.student.description': 'كطالب حالي في أكاديمية علاديا، أحِل 5 أصدقاء يسجلون بالكامل ويكملون 30% على الأقل من دروسهم. بمجرد وصول الجميع للهدف، تحصل على $1,000 نقدًا.',
    ...
    'referral.student.step3': 'يكمل جميع المُحالين الخمسة 30% على الأقل من الدورة',
    'referral.student.step4': 'تحصل على $1,000 في حسابك',
    'referral.student.reward': 'اكسب $1,000 عندما يصل جميع المُحالين الخمسة إلى 30%',
    ...
    'referral.affiliate.description': 'لا تحتاج أن تكون طالبًا. أحِل 5 أشخاص يسجلون ويدفعون لأي دورة في أكاديمية علاديا ويكملون 30% من المحتوى. بمجرد تأهل الخمسة، تكسب $1,000.',
    'referral.affiliate.step1': 'سجّل كشريك في أكاديمية علاديا (مجانًا)',
    'referral.affiliate.step2': 'شارك رابط الشراكة في شبكتك',
    'referral.affiliate.step3': 'يكمل المُحالون الخمسة التسجيل والدفع و30% من الدورة',
    'referral.affiliate.step4': 'تحصل على $1,000 في حسابك',
    'referral.affiliate.reward': 'اكسب $1,000 عندما يكمل المُحالون الخمسة 30% من الدورة',
    ...
    'referral.terms.t2': 'مكافآت إحالة الطلاب تتطلب إكمال جميع المُحالين الخمسة 30% كحد أدنى.',
  ...
  fr: {
    ...
    'referral.student.description': 'En tant qu\'étudiant actif d\'Aladiah Academy, parrainez 5 amis qui s\'inscrivent et complètent au moins 30% de leurs cours. Une fois les 5 objectifs atteints, vous recevez $1,000 en espèces.',
    ...
    'referral.student.step3': 'Les 5 filleuls complètent au moins 30% de leur cours',
    'referral.student.step4': 'Vous recevez $1,000 déposés sur votre compte',
    'referral.student.reward': 'Gagnez $1,000 quand vos 5 filleuls atteignent 30%',
    ...
    'referral.affiliate.description': 'Vous n\'avez pas besoin d\'être étudiant. Parrainez 5 personnes qui s\'inscrivent, paient un cours Aladiah Academy et complètent au moins 30% du contenu. Une fois les 5 qualifiés, vous gagnez $1,000.',
    ...
    'referral.affiliate.step3': 'Les 5 filleuls complètent inscription, paiement et 30% du cours',
    'referral.affiliate.step4': 'Vous recevez $1,000 déposés sur votre compte',
    'referral.affiliate.reward': 'Gagnez $1,000 quand les 5 filleuls complètent 30% du cours',
    ...
    'referral.terms.t2': 'Les récompenses étudiantes nécessitent que les 5 filleuls complètent au moins 30% du cours.',
  ...
  de: {
    ...
    'referral.student.description': 'Als aktiver Student der Aladiah Academy empfehlen Sie 5 Freunde, die sich vollständig registrieren und mindestens 30% ihrer Kurse abschließen. Sobald alle 5 das Ziel erreichen, erhalten Sie $1,000 bar.',
    ...
    'referral.student.step3': 'Alle 5 Empfehlungen schließen mindestens 30% ihres Kurses ab',
    'referral.student.step4': 'Sie erhalten $1,000 auf Ihr Konto',
    'referral.student.reward': 'Verdienen Sie $1,000 wenn alle 5 Empfehlungen 30% erreichen',
    ...
    'referral.affiliate.description': 'Sie müssen kein Student sein. Empfehlen Sie 5 Personen, die sich registrieren, für einen Kurs bezahlen und mindestens 30% des Kursinhalts abschließen. Sobald alle 5 qualifiziert sind, verdienen Sie $1,000.',
    ...
    'referral.affiliate.step3': 'Alle 5 Empfehlungen schließen Registrierung, Zahlung und 30% des Kurses ab',
    'referral.affiliate.step4': 'Sie erhalten $1,000 auf Ihr Konto',
    'referral.affiliate.reward': 'Verdienen Sie $1,000 wenn alle 5 Empfehlungen 30% abschließen',
    ...
    'referral.terms.t2': 'Studentenempfehlungs-Prämien erfordern, dass alle 5 Empfehlungen mindestens 30% des Kurses abschließen.',
  ...
  ja: {
    ...
    'referral.student.description': 'Aladiah Academyの在籍学生として、完全に登録しコースの少なくとも30%を完了する5人の友人を紹介してください。5人全員がマイルストーンに到達すると、$1,000の現金を獲得できます。',
    'referral.student.step1': '友人や同僚に専用の紹介リンクを共有',
    'referral.student.step2': '紹介者がコースに登録し受講開始',
    'referral.student.step3': '5人全員がコースの30%以上を完了',
    'referral.student.step4': 'あなたのアカウントに$1,000が振り込まれます',
    'referral.student.reward': '5人の紹介者が30%完了時に$1,000獲得',
    'referral.student.cta': '登録して紹介を開始',
    'referral.affiliate.title': 'アフィリエイトプログラム',
    'referral.affiliate.subtitle': '登録不要——共有して稼ぐだけ',
    'referral.affiliate.description': '学生である必要はありません。Aladiah Academyのコースに登録・支払いを完了し、少なくとも30%のコース内容を修了する5人を紹介してください。5人全員が達成すると、$1,000を獲得できます。',
    'referral.affiliate.step1': 'Aladiah Academyアフィリエイトに無料登録',
    'referral.affiliate.step2': 'ネットワークでアフィリエイトリンクを共有',
    'referral.affiliate.step3': '5人全員が登録、支払い、30%のコースを完了',
    'referral.affiliate.step4': 'あなたのアカウントに$1,000が振り込まれます',
    'referral.affiliate.reward': '5人の紹介者が30%完了時に$1,000獲得',
    ...
    'referral.terms.t2': '学生紹介報酬は5人全員がコースの最低30%を完了する必要があります。',
