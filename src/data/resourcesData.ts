...
export const RESOURCE_TRACKS: ResourceTrack[] = [
  ...
  { id:"human-ai-interaction-specialist", school:'🎨 Human-AI Experience', color:"#9B59B6", icon:"🤖",
    ...
    resources:[
      {label:"Stanford HAI Research", url:"https://hai.stanford.edu/research", type:"Research", free:true},
      {label:"MIT Media Lab Research", url:"https://www.media.mit.edu/research/", type:"Research", free:true},
      {label:"Nielsen Norman HCI Articles", url:"https://www.nngroup.com/articles/", type:"Reference", free:true},
      {label:"ACM Digital Library CHI", url:"https://dl.acm.org/conference/chi", type:"Research", free:false},
    ],
    glossary:[
