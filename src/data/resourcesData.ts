...
export const RESOURCE_TRACKS: ResourceTrack[] = [
  ...
  { id:"ai-solutions-architect", school:'⚙️ AI Engineering', color:"#4A90F5", icon:"🏛️",
    ...
    resources:[
      {label:"AWS Well-Architected Framework", url:"https://aws.amazon.com/architecture/well-architected/", type:"Framework", free:true},
      {label:"Google Cloud Architecture Center", url:"https://cloud.google.com/architecture", type:"Framework", free:true},
      {label:"Azure Architecture Center", url:"https://learn.microsoft.com/azure/architecture/", type:"Official Docs", free:true},
      {label:"TOGAF Standard Overview", url:"https://www.opengroup.org/togaf", type:"Standard", free:false},
      {label:"LangChain Architecture Guide", url:"https://docs.langchain.com/", type:"Official Docs", free:true},
    ],
    glossary:[
      {term:"Solution Architecture", def:"The process of designing and describing the structure of a solution to meet business requirements."},
  ...
  { id:"ai-platform-engineer", school:'⚙️ AI Engineering', color:"#4A90F5", icon:"🔧",
    ...
    resources:[
      ...
      {label:"MLflow Documentation", url:"https://mlflow.org/docs/latest/", type:"Official Docs", free:true},
      {label:"Kubeflow Docs", url:"https://www.kubeflow.org/docs/", type:"Official Docs", free:true},
      {label:"Feast Feature Store Docs", url:"https://docs.feast.dev/", type:"Official Docs", free:true},
      {label:"Ray Documentation", url:"https://docs.ray.io/", type:"Official Docs", free:true},
    ],
    glossary:[
      {term:"MLOps", def:"The practice of applying DevOps principles to machine learning systems."},
      {term:"Feature Store", def:"A centralized repository for storing and serving ML features."},
      {term:"Model Registry", def:"A versioned catalog of trained models with metadata and lifecycle management."},
    ]},
  ...
  { id:"ai-solutions-consultant", school:'💼 AI Business', color:"#F0622A", icon:"🤝",
    ...
    resources:[
      ...
      {label:"Harvard Business Review AI", url:"https://hbr.org/topic/subject/ai-and-machine-learning", type:"Research", free:true},
      {label:"Google AI for Business", url:"https://cloud.google.com/transform", type:"Guide", free:true},
    ],
    glossary:[
  ...
  { id:"ai-product-manager", school:'💼 AI Business', color:"#F0622A", icon:"📱",
    ...
    resources:[
      {label:"Google PAIR Guidebook", url:"https://pair.withgoogle.com/guidebook/", type:"Guide", free:true},
      {label:"OpenAI Product Guidelines", url:"https://openai.com/product", type:"Guide", free:true},
      {label:"Anthropic Responsible Scaling Policy", url:"https://www.anthropic.com/index/anthropics-responsible-scaling-policy", type:"Guide", free:true},
      {label:"Reforge Product Management", url:"https://www.reforge.com/", type:"Course", free:false},
    ],
    glossary:[
  ...
  { id:"ai-business-operations", school:'💼 AI Business', color:"#F0622A", icon:"⚙️",
    ...
    resources:[
      ...
      {label:"n8n Documentation", url:"https://docs.n8n.io/", type:"Official Docs", free:true},
      {label:"SAFe 6.0 Framework", url:"https://scaledagileframework.com/", type:"Framework", free:true},
      {label:"BABOK Guide (IIBA)", url:"https://www.iiba.org/babok/", type:"Guide", free:false},
    ],
    glossary:[
  ...
  { id:"ai-sales-engineer", school:'💼 AI Business', color:"#F0622A", icon:"💡",
    ...
    resources:[
      ...
      {label:"HubSpot AI Features", url:"https://www.hubspot.com/artificial-intelligence", type:"Reference", free:true},
      {label:"MEDDIC Sales Framework", url:"https://www.meddic.com/", type:"Guide", free:true},
      {label:"Gong AI Sales Intelligence", url:"https://www.gong.io/product/", type:"Tool", free:false},
    ],
    glossary:[
  ...
  { id:"ai-business-analyst", school:'💼 AI Business', color:"#F0622A", icon:"📊",
    ...
    resources:[
      ...
      {label:"Tableau Learning", url:"https://www.tableau.com/learn", type:"Course", free:true},
      {label:"Power BI Documentation", url:"https://learn.microsoft.com/power-bi/", type:"Official Docs", free:true},
      {label:"Mode SQL Tutorial", url:"https://mode.com/sql-tutorial/", type:"Tutorial", free:true},
      {label:"Google Data Analytics Certificate", url:"https://grow.google/certificates/data-analytics/", type:"Cert", free:false},
    ],
    glossary:[
  ...
  { id:"ai-transformation-manager", school:'💼 AI Business', color:"#F0622A", icon:"🔄",
    ...
    resources:[
      ...
      {label:"Kotter 8-Step Change Model", url:"https://www.kotterinc.com/methodology/", type:"Framework", free:true},
      {label:"BCG AI Transformation", url:"https://www.bcg.com/capabilities/artificial-intelligence/overview", type:"Report", free:true},
      {label:"Prosci ADKAR Model", url:"https://www.prosci.com/methodology/adkar", type:"Framework", free:false},
    ],
    glossary:[
  ...
  { id:"ai-program-manager", school:'💼 AI Business', color:"#F0622A", icon:"📋",
    ...
    resources:[
      ...
      {label:"Scrum Guide", url:"https://scrumguides.org/", type:"Guide", free:true},
      {label:"OKR Framework (Google)", url:"https://rework.withgoogle.com/guides/set-goals-with-okrs/", type:"Framework", free:true},
      {label:"Atlassian Jira Docs", url:"https://support.atlassian.com/jira-software-cloud/", type:"Official Docs", free:true},
    ],
    glossary:[
  ...
  { id:"ai-enterprise-architect", school:'💼 AI Business', color:"#F0622A", icon:"🏢",
    ...
    resources:[
      ...
      {label:"AWS Well-Architected Framework", url:"https://aws.amazon.com/architecture/well-architected/", type:"Framework", free:true},
      {label:"Microsoft Cloud Adoption Framework", url:"https://learn.microsoft.com/azure/cloud-adoption-framework/", type:"Guide", free:true},
      {label:"Gartner Enterprise Architecture", url:"https://www.gartner.com/en/information-technology/topics/enterprise-architecture", type:"Reference", free:false},
    ],
    glossary:[
      {term:"Enterprise Architecture", def:"The organizing logic for business processes and IT infrastructure reflecting integration requirements."},
      {term:"Capability Map", def:"A visual representation of business capabilities aligned to strategic objectives."},
    ]},
  ...
  { id:"responsible-ai-specialist", school:'⚖️ Governance & Risk', color:"#22C98A", icon:"🤝",
    ...
    resources:[
      ...
      {label:"Anthropic Responsible Scaling Policy", url:"https://www.anthropic.com/index/anthropics-responsible-scaling-policy", type:"Guide", free:true},
      {label:"IEEE Ethically Aligned Design", url:"https://ethicsinaction.ieee.org/", type:"Standard", free:true},
      {label:"Partnership on AI Resources", url:"https://partnershiponai.org/resources/", type:"Research", free:true},
      {label:"AI Now Institute Reports", url:"https://ainowinstitute.org/reports", type:"Research", free:true},
    ],
    glossary:[
  ...
  { id:"ai-compliance-officer", school:'⚖️ Governance & Risk', color:"#22C98A", icon:"📋",
    ...
    resources:[
      ...
      {label:"ISO 42001 Overview", url:"https://www.iso.org/standard/81230.html", type:"Standard", free:false},
      {label:"GDPR Full Text", url:"https://gdpr-info.eu/", type:"Regulation", free:true},
      {label:"FTC AI Guidance", url:"https://www.ftc.gov/business-guidance/blog/2023/02/keep-your-ai-claims-in-check", type:"Guide", free:true},
    ],
    glossary:[
  ...
  { id:"ai-risk-manager", school:'⚖️ Governance & Risk', color:"#22C98A", icon:"⚠️",
    ...
    resources:[
      ...
      {label:"MITRE ATLAS (AI Threats)", url:"https://atlas.mitre.org/", type:"Reference", free:true},
      {label:"OWASP LLM Top 10", url:"https://owasp.org/www-project-top-10-for-large-language-model-applications/", type:"Guide", free:true},
    ],
    glossary:[
  ...
  { id:"ai-auditor", school:'⚖️ Governance & Risk', color:"#22C98A", icon:"🔍",
    ...
    resources:[
      ...
      {label:"Model Cards (Google)", url:"https://modelcards.withgoogle.com/", type:"Framework", free:true},
      {label:"Datasheets for Datasets (arXiv)", url:"https://arxiv.org/abs/1803.09010", type:"Research", free:true},
      {label:"Ada Lovelace Institute AI Audit", url:"https://www.adalovelaceinstitute.org/", type:"Toolkit", free:true},
    ],
    glossary:[
  ...
  { id:"ai-policy-designer", school:'⚖️ Governance & Risk', color:"#22C98A", icon:"📜",
    ...
    resources:[
      {label:"OECD AI Principles", url:"https://oecd.ai/en/ai-principles", type:"Reference", free:true},
      {label:"UNESCO AI Ethics Recommendation", url:"https://www.unesco.org/en/artificial-intelligence/recommendation-ethics", type:"Guide", free:true},
      {label:"White House AI Executive Order", url:"https://www.whitehouse.gov/briefing-room/presidential-actions/2023/10/30/executive-order-on-the-safe-secure-and-trustworthy-development-and-use-of-artificial-intelligence/", type:"Regulation", free:true},
      {label:"GPAI Global Partnership on AI", url:"https://gpai.ai/projects/", type:"Research", free:true},
    ],
    glossary:[
  ...
  { id:"ai-ethics-specialist", school:'⚖️ Governance & Risk', color:"#22C98A", icon:"⚖️",
    ...
    resources:[
      ...
      {label:"EU Ethics Guidelines for Trustworthy AI", url:"https://digital-strategy.ec.europa.eu/en/library/ethics-guidelines-trustworthy-ai", type:"Guide", free:true},
      {label:"MIT OpenCourseWare AI Ethics", url:"https://ocw.mit.edu/", type:"Course", free:true},
      {label:"AI Ethics Lab", url:"https://aiethicslab.com/", type:"Reference", free:true},
    ],
    glossary:[
      {term:"Algorithmic Bias", def:"Systematic and repeatable errors in a computer system that create unfair outcomes."},
      {term:"Explainability", def:"The degree to which a human can understand and interpret an AI model decisions."},
    ]},
  ...
  { id:"ai-ux-designer", school:'🎨 Human-AI Experience', color:"#9B59B6", icon:"🎨",
    ...
    resources:[
      ...
      {label:"Microsoft HAX Toolkit", url:"https://www.microsoft.com/en-us/haxtoolkit/", type:"Toolkit", free:true},
      {label:"Apple Human Interface Guidelines", url:"https://developer.apple.com/design/human-interface-guidelines/", type:"Guide", free:true},
      {label:"Nielsen Norman AI UX Research", url:"https://www.nngroup.com/topic/artificial-intelligence/", type:"Research", free:true},
      {label:"Figma AI Design Resources", url:"https://www.figma.com/ai/", type:"Tool", free:true},
    ],
    glossary:[
  ...
  { id:"conversation-designer", school:'🎨 Human-AI Experience', color:"#9B59B6", icon:"💬",
    ...
    resources:[
      {label:"Conversation Design Institute", url:"https://www.conversationdesigninstitute.com/", type:"Course", free:false},
      {label:"Google Dialogflow Docs", url:"https://cloud.google.com/dialogflow/docs", type:"Official Docs", free:true},
      {label:"Amazon Lex Documentation", url:"https://docs.aws.amazon.com/lex/", type:"Official Docs", free:true},
      {label:"Voiceflow Documentation", url:"https://docs.voiceflow.com/", type:"Official Docs", free:true},
    ],
    glossary:[
  ...
  { id:"ai-workflow-designer", school:'🎨 Human-AI Experience', color:"#9B59B6", icon:"🔀",
    ...
    resources:[
      ...
      {label:"Make Automation Docs", url:"https://www.make.com/en/help", type:"Official Docs", free:true},
      {label:"LangGraph Documentation", url:"https://langchain-ai.github.io/langgraph/", type:"Official Docs", free:true},
      {label:"CrewAI Documentation", url:"https://docs.crewai.com/", type:"Official Docs", free:true},
    ],
    glossary:[
  ...
  { id:"ai-experience-architect", school:'🎨 Human-AI Experience', color:"#9B59B6", icon:"✨",
    ...
    resources:[
      ...
      {label:"IDEO Design Thinking", url:"https://designthinking.ideo.com/", type:"Guide", free:true},
      {label:"Salesforce CX AI Playbook", url:"https://www.salesforce.com/products/einstein/customer-experience/", type:"Guide", free:true},
      {label:"Baymard Institute UX Research", url:"https://baymard.com/", type:"Research", free:false},
    ],
    glossary:[
      {term:"Experience Architecture", def:"The holistic design of interactions between humans and AI across all touchpoints."},
      {term:"Journey Mapping", def:"Visualizing the end-to-end experience of a user interacting with an AI system."},
    ]},
];
